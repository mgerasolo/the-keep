...
Reference full template: `/home/mgerasolo/Dev/the-keep/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/mgerasolo/Dev/the-keep/.claude/get-shit-done/templates/state.md`.
