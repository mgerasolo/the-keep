...
- **Global scope**: `/home/mgerasolo/Dev/the-keep/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/mgerasolo/Dev/the-keep/.claude/notes/`)
...
2. Glob `/home/mgerasolo/Dev/the-keep/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/mgerasolo/Dev/the-keep/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/mgerasolo/Dev/the-keep/.claude/notes/` — works in any directory
