...
<!-- For checkpoint task examples and patterns, see @/home/mgerasolo/Dev/the-keep/.claude/get-shit-done/references/checkpoints.md -->
...
See `/home/mgerasolo/Dev/the-keep/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/home/mgerasolo/Dev/the-keep/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/home/mgerasolo/Dev/the-keep/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
